...
public class BlackJackController implements Initializable {
	...
	public void btnHit_Click(ActionEvent event) {
		...
		TranslateTransition transT = CreateTranslateTransition(pntDeck, new Point2D(pntCardDealt.getX()-2,(pntCardDealt.getY()+33)), img);

		// Create a Rotate transition
		RotateTransition rotT = CreateRotateTransition(img);
		rotT.setFromAngle(0.0);
		rotT.setToAngle(180.0);
		rotT.setAxis(img.getRotationAxis());
		...
		//PathTransition pathT = CreatePathTransition(pntDeck, pntDeck, img);
